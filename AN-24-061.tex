...
\title{Search for electroweak WZ production in the WZjj->tau nu ll jj channel}
...
pdftitle={Search for electroweak WZ production in the WZjj->tau nu ll jj channel},%
pdfsubject={CMS},%
...
\bibliography{AN-24-061} % this will be replaced with {auto_generated} when processed by tdr, which is a combination of all .bib files in the directory.
